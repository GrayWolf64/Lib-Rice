...
function RiceUI.Examples.Register(name, data)
    Examples[name] = data
end

RiceUI.Examples.Register("Modern", {
    {type = "rl_frame2",
        Text = "Example",
        Center = true,
        Root = true,
...
RiceUI.Examples.Register("Panel_3D", {
    {type = "rl_frame",
        Center = true,
        Root = true,
...
RiceUI.Examples.Register("Playground", {
    {type = "rl_frame",
        Center = true,
        Root = true,
...
RiceUI.Examples.Register("Animations", {
    {type = "rl_frame2",
        Center = true,
        Root = true,
...
Examples.ModernBlack = table.Copy(Examples.Modern)
Examples.ModernBlack[1].Theme = {
    ThemeName = "modern",
    ThemeType = "RL_Frame2",
    Color = "black",
    TextColor = "black",
...
RiceUI.Examples.Register("ProceduralAnimation", {
    {type = "rl_frame2",
        Center = true,
        Root = true,
    ...
    RiceUI.SimpleCreate({type = "rl_frame2",
        ...
        children = {
            {type = "rl_scrollpanel",
                ...
                OnCreated = function(self)
                    for k, v in SortedPairs(Examples) do
                        self:AddItem(RiceUI.SimpleCreate({type = "rl_button",
                            Dock = TOP,
                            Margin = {0, 0, 0, 8},
                            h = 50,
