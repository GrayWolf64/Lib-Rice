...
local colors = {
    white = {
        ...
        Stroke = {
            ...
            Panel = {
                Glass = ColorAlpha(color_white, 100),
            },
        ...
        Fill = {
            ...
            Control = {
                ...
                Active = color_white,
                Switch = Color(100, 100, 100),
            },

            Panel = {
                Glass = ColorAlpha(color_white, 50),
            },
...
local themePanel = {
    ...
    Glass = function(self, w, h, style)
        ...
        draw.RoundedBoxEx(radius, 0, 0, w, h, self:RiceUI_GetColor("Stroke", "Panel", "Glass"), unpack(corner))

        render.SetStencilEnable(false)

        draw.RoundedBoxEx(radius, 0, 0, w, h, self:RiceUI_GetColor("Fill", "Panel", "Glass"), unpack(corner))
    end,
