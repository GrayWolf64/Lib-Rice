...
function tbl.Panel(pnl,w,h)
    surface.SetDrawColor(pnl.Theme.RawColor or tbl.Color[pnl.Theme.Color] or tbl.Color.white1)
    surface.DrawRect(0,0,w,h)
end

function tbl.Button(pnl,w,h)
    surface.SetDrawColor(pnl.Theme.RawOutlineColor or tbl.OutlineColor[pnl.Theme.Color] or tbl.OutlineColor.white1)
    surface.DrawRect(0,0,w,h)
